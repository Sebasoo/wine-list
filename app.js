const WINES = [
  {
    id: "ceci-bruno",
    name: "Ceci Bruno Emilia Lambrusco",
    sub: "Игристое · Emilia · 0,75 л",
    price: 52,
    type: "sparkling",
    image: "images/ceci-bruno.png?v=4",
    glow: "#2a3a6a",
  },
  {
    id: "franz-haas-sofi",
    name: "Franz Haas Sofi Rosso",
  ...
  {
    id: "sancerre-les-baronnnes",
    name: "Henri Bourgeois Sancerre Les Baronnes",
    sub: "Белое · Loire · 0,375 л",
    note: "Не смущайтесь маленького размера — в таком объёме эти вина ещё лучше",
    price: 64,
    type: "white",
    image: "images/sancerre-les-baronnnes.png?v=5",
    glow: "#8a7340",
  },
  {
    id: "tempo-angelus",
    name: "Tempo d'Angelus Bordeaux 2022",
    sub: "Красное · Bordeaux · 0,375 л",
    note: "Не смущайтесь маленького размера — в таком объёме эти вина ещё лучше",
    price: 69,
    type: "red",
    image: "images/tempo-angelus.png?v=4",
    glow: "#8a2430",
  },
  {
    id: "salvatge-rose",
    name: "Salvatge 2018 Rosé",
    sub: "Игристое · Corpinnat · 0,75 л",
    price: 82,
    type: "sparkling",
    image: "images/salvatge-rose.png?v=5",
    glow: "#a0456a",
  },
  {
    id: "chatelain-pouilly",
    name: "Domaine Chatelain Pouilly-Fumé Prestige",
    sub: "Белое · Loire · 0,75 л",
    price: 99,
    type: "white",
    image: "images/chatelain-pouilly.png?v=6",
    glow: "#7a6a40",
  },
  {
    id: "papale-primitivo",
    name: "Papale Primitivo di Manduria Linea Oro",
    sub: "Красное · Puglia · 0,75 л",
    price: 109,
    type: "red",
    image: "images/papale-primitivo.png?v=4",
    glow: "#7a1f28",
  },
  {
    id: "zorah-karasi",
    name: "Zorah Karasì",
    sub: "Красное · Армения · 0,75 л",
    price: 119,
    type: "red",
    image: "images/zorah-karasi.png?v=4",
    glow: "#6a4030",
  },
  {
    id: "braida-baciale",
    name: "Braida Il Bacialé Monferrato Rosso",
    sub: "Красное · Monferrato · 0,75 л",
    price: 139,
    type: "red",
    image: "images/braida-baciale.png?v=4",
    glow: "#8a3038",
  },
  {
    id: "chateau-cantelys",
    name: "Château Cantelys Pessac-Léognan 2020",
    sub: "Белое · Pessac-Léognan · 0,75 л",
    price: 159,
    type: "white",
    image: "images/chateau-cantelys.png?v=5",
    glow: "#8a7a48",
  },
  {
    id: "margaux-de-brane",
    name: "Margaux de Brane",
    sub: "Красное · Margaux · 0,75 л",
    price: 165,
    type: "red",
    image: "images/margaux-de-brane.png?v=6",
    glow: "#8a6a30",
  },
  {
    ...
    price: 209,
    type: "white",
    image: "images/coudoulet-beaucastel.png?v=5",
    glow: "#9a7a30",
  },
  {
  ...
  {
    id: "penfolds-grandfather",
    name: "Penfolds Grandfather Rare Tawny",
    sub: "Креплёное · Australia · 0,75 л",
    price: 289,
    type: "red",
    image: "images/penfolds-grandfather.png?v=4",
    glow: "#8a2a28",
  },
];
